...
const formalShoes = shoeData.filter((shoe) => shoe.category === "formal");
...
const currentData = formalShoes.slice(
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Shoe Items Section */}
      <div
        className="flex  lg:flex-row flex-col items-center justify-center lg:mb-20"
        data-aos="fade-up"
 ...
 border border-gray-300 rounded-md p-2">
        ...
        <div className="lg:w-[1200px]">
          <p className="text-titleMd ml-5 mt-5 mb-5">Formals</p>
          ...
          <div className="flex flex-wrap gap-6 w-[100%] justify-center ">
            {currentData
              ?.filter((shoe) => shoe.category === "formal") // Filter only 'formal' shoes
              .map((shoe) => (
                <div
                  key={shoe.id}
