        ...
        <div className='overflow-hidden mb-20'>
            ...
            <div className="flex justify-center mt-44 gap-20">
                ...
                <ScrollTrigger onEnter={() => setAnimate(true)}>
                 {animate&&   <div className='flex  justify-center gap-20'>  
                    <div className="text-[13em] absolute z-10 font-bold text-[#c300109c] mt-20 formal-collection-text animate__animated animate__fadeInUp">
                        Formal Collection
                    </div>
                        <div className="absolute text-titleXl z-10 mt-[310px] mr-14 animate__animated animate__fadeInUp"><span className="text-white">Starting</span><span className="text-red"> at</span> <span className="text-white">$19.99</span> </div>
                        ...
                        <div >
                            ...
                            <div
                                className="relative rounded-lg w-[400px] h-[510px] shadow-xl animate__animated animate__fadeInRight"
                                style={{
