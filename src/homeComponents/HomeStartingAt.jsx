...
export default function HomeStartingAt() {
    ...
    return (
        <div className='overflow-hidden mb-20'>
            ...
            <div className="flex justify-center lg:mt-44 gap-20">
                ...
                <div className='flex  justify-center lg:gap-20 gap-3'>
                    <div className="lg:text-[13em] text-titleLg absolute z-10 font-bold lg:text-[#c300109c] text-white mt-20 formal-collection-text" data-aos="fade-up"
                        data-aos-duration="3000">
                        Formal Collection
                    </div>
                    <div className="absolute text-titleMd    lg:text-titleXl z-10 lg:mt-[310px] mt-[250px] lg:mr-14 " data-aos="fade-down"
                        data-aos-duration="3000"><span className="lg:text-white">Starting</span><span className="lg:text-red"> at</span> <span className="lg:text-white">$19.99</span> </div>
                    <button className="group uppercase absolute z-10 lg:mt-[400px] mt-[320px] transition-all duration-300" >
                    ...
                    <div data-aos="fade-right"
                        ...
                        <div
                            ...
                            className="relative rounded-lg lg:w-[400px] h-[230px] w-[180px] lg:h-[510px] shadow-xl animate__animated animate__fadeInLeft"
                            style={{
                    ...
                    <div data-aos="fade-left"
                        ...
                        <div
                            className="relative rounded-lg h-[230px] w-[180px] lg:w-[400px] lg:h-[510px] shadow-xl"
                            style={{
